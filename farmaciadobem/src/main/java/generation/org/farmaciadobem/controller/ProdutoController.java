...
import generation.org.farmaciadobem.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getByDescricao(@Valid @PathVariable String descricao) {
		return ResponseEntity.ok(produtoRepository.findAllByIdDescricaoContainingIgnoreCase(descricao));
	}
